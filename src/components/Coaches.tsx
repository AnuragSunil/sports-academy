...
const coaches: Coach[] = [
  { name: "Alice", designation: "Tennis Coach", description: "Expert in advanced techniques and strategy, helping players reach their full potential on court.", image: "/coaches/A.jpg" },
